...
2. **Analysis:** Performed exploratory data analysis (EDA) to identify student engagement trends and assessment completion rates.  

3. **Visualization:** Developed clear, actionable visual insights using Matplotlib/Seaborn, focusing on the KPIs most relevant to EdTech growth
4. **Environment:** Includes a requirements.txt and README.md for seamless local setup.
